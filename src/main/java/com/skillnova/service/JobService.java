...
public class JobService {
    ...
    private static final BigDecimal MIN_LOGICAL_BUDGET_NPR = new BigDecimal("1000");
    ...
    private Job buildJob(long clientId, long jobId, String title, String description, String budgetMinRaw, String budgetMaxRaw,
        ...
        if (budgetMin.compareTo(MIN_LOGICAL_BUDGET_NPR) < 0) {
            throw new IllegalArgumentException("Minimum budget should be at least NPR 1,000.");
        }
