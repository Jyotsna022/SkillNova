...
public final class SessionUtil {
    ...
    public static void createUserSession(HttpServletRequest request, long userId, String fullName, String role) {
        createUserSession(request, userId, fullName, role, null);
    }

    public static void createUserSession(HttpServletRequest request, long userId, String fullName, String role, String accountStatus) {
