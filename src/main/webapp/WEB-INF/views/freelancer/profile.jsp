...
<head>
    ...
    <title>Freelancer Profile - SkillNova</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 820px) {
            ...
            .hero, .panel-head, .body { padding: 12px; }
...
<body>
<% Map<String, String> p = (Map<String, String>) request.getAttribute("profile"); %>
...
<header class="topbar">
    <div class="bar-left">
        ...
        <nav class="nav">
            ...
            <a class="active" href="${pageContext.request.contextPath}/freelancer/profile">Profile</a>
...
<div class="shell">
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
            ...
            <a class="active" href="${pageContext.request.contextPath}/freelancer/profile"><span class="material-symbols-rounded">settings</span>Settings</a>
    ...
    <main class="content">
    <section class="hero">
        <h1>Keep your profile sharp and discoverable</h1>
        <p>Update your headline, experience, rate, and bio to improve client matches and interview invites.</p>
    </section>
    ...
    <section class="panel">
        <div class="panel-head">
            <h2>Freelancer Profile Management</h2>
        </div>
        <div class="body">
            <form class="form" method="post" action="${pageContext.request.contextPath}/freelancer/profile">
                <input type="hidden" name="action" value="updateFreelancerProfile" />

                <label class="label" for="headline">Headline</label>
                <input class="input" id="headline" name="headline" value="<%= p == null ? "" : p.getOrDefault("headline", "") %>" />

                <label class="label" for="yearsExperience">Years of Experience</label>
                <input class="input" id="yearsExperience" type="number" min="0" name="yearsExperience" value="<%= p == null ? "0" : p.getOrDefault("yearsExperience", "0") %>" />

                <label class="label" for="hourlyRate">Hourly Rate</label>
                <input class="input" id="hourlyRate" type="number" step="0.01" min="0" name="hourlyRate" value="<%= p == null ? "" : p.getOrDefault("hourlyRate", "") %>" />

                <label class="label" for="bio">Bio</label>
                <textarea class="textarea" id="bio" name="bio"><%= p == null ? "" : p.getOrDefault("bio", "") %></textarea>
